(function($) {
    ...
    function dynamicMenuClass(selector) {
        ...
        if ('' == FileName) {
            selector.find('li').eq(0).addClass('');
        }
    }

    // dynamic  class        
    let mainNavUL = $('.main-menu').find('.navigation');
    dynamicMenuClass(mainNavUL);
	...
	$(".languages li a").click(function(){
       ...
       $('.languages .').html(showLang);
       $('.languages .').attr("title", selectedValue);
