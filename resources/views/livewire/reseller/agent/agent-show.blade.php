                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-separator">
                            <div class="page-separator__text">Show Sub Agent</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ $customerDetails->phone }}" disabled type="text"
                                class="form-control mb-2">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Address</label>
                            <input disabled value="{{ $customerDetails->address }}" type="text"
                                class="form-control mb-2">
                        </div>
                        <div class="form-group">
                            <label class="form-label">MSP Type</label>
                            <select disabled class="form-control custom-select">
                                <option {{ $customerDetails->msp_type == 'percentage' ? 'selected' : '' }}
                                    value="percentage">
                                    Percentage</option>
                                <option {{ $customerDetails->msp_type == 'amount' ? 'selected' : '' }} value="amount">
                                    Amount
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <input disabled value="{{ $customerDetails->msp }}" type="number"
                                class="form-control mb-2">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled value="{{ $user->grade->name }}" type="text" class="form-control mb-2">
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <div class="card mb-lg-32pt mt-2">
                            <div class="table-responsive" data-toggle="lists" data-lists-sort-by="js-lists-values-date"
                                ...
                                <div class="card-footer p-8pt">
                                    {{ $customers->links() }}
                                    <button class="btn btn-primary mt-2" wire:click="assignUsers">Save
                                        changes</button>
                                </div>
                            </div>
                        </div>
