<div>
    ...
    {{-- <div class="form-group">
        ...
        <input value="{{ $user->customerDetails->msp ?? 0 }}" disabled type="number" class="form-control mb-2">
    </div> --}}
    {{-- <div class="form-group">
    ...
    @if ($user->customerDetails)
        <div class="form-group">
            ...
            <input value="{{ $user->customerDetails->request_limit }}" disabled type="number"
        ...
        <div class="form-group">
            ...
            <input value="{{ $user->customerDetails->profit_margin }}" type="number" class="form-control mb-2"
                disabled>
        </div>
        <div class="form-group">
            <label class="form-label">Profit Margin</label>
            <select class="form-control custom-select" disabled>
                ...
                <option {{ $user->customerDetails->profit_margin_type == 'amount' ? 'selected' : '' }} value="amount">
                    Amount
                </option>
            </select>
        </div>
