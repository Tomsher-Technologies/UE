            ...
            <div class="table-responsive" data-toggle="lists" data-lists-sort-by="js-lists-values-date"
                ...
                <div class="card-header">
                    <form class="form-inline" wire:ignore>
                        ...
                        <div class="mr-2">
                            <label class="mr-sm-2 mb-2 form-label justify-content-start" for="inlineFormFilterBy">Filter
                                by user:</label>
                            <select wire:model="user_id" name="user"
                        ...
                        <div class="mr-3">
                            <label class="mr-sm-2 mb-2 form-label justify-content-start" for="inlineFormFilterBy">Filter
                                by from
                                country:</label>
                            <select wire:model="from_country_id" name="from_country_id"
                        ...
                        <div class="mr-2">
                            <label class="mr-sm-2 mb-2 form-label justify-content-start" for="inlineFormFilterBy">Filter
                                by to
                                country:</label>
                            <select wire:model="to_country_id" name="to_country_id"
                        ...
                        <div class="mr-2">
                            ...
                            <select wire:model="shipping_type" name="shipping_type"
                        ...
                        <div class="mr-2">
                            ...
                            <select wire:model="package_type" name="package_type"
                        ...
                        <div class="mr-2">
                            <label class="mr-sm-2 mb-2 form-label justify-content-start" for="inlineFormFilterBy">Filter
                                by package type:</label>
                            <input class="flatpickr flatpickr-input form-control" type="hidden"
