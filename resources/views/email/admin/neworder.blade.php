              ...
              >
                <div align="center">
                  ...
                  <div class="temp-header" style="max-width: 600px">
                    <div
                      class="temp-fullbleed contained"
                                    ...
                                    <div class="text-element paragraph">
                                      ...
                                      >
                                        ...
                                        <p
                                          ...
                                          "
                                        >
                                          Hi admin, you have recived a new order from the portal.
                                        </p>
                                        <br />
										...
										<p
                                          ...
                                          "
                                        >
                                          <span>Order ID:</span>: {{ $order->hawbNumber }}
                                        </p>
										<p
                                          style="
                                            color: rgb(51, 51, 51);
                                          ...
                                          "
                                        >
                                          <span>Label URL:</span>: <a href="{{ $order->invoice_url }}" target="new">{{ $order->invoice_url }}</a>
                                        </p>
                                        <br />
